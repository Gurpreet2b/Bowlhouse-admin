...
export class ChartOrderAmountComponent implements OnInit, OnChanges  {
   
    @Input() ChartOrderAmount: any;
    ...
    public chartintialize() {
        ...
        series: [{
            type: 'pie',
            name: 'Order Amount Stats',
            data: this.ChartOrderAmount,
            size: '100%',
        }]
     };
    }
