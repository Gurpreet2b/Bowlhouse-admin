...
@Component({
  selector: 'app-collectedtax',
  templateUrl: './collectedtax.component.html',
  styleUrls: ['./collectedtax.component.css']
})
export class CollectedtaxComponent implements OnInit {
