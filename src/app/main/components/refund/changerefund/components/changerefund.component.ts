...
@Component({
  selector: 'app-changerefund',
  templateUrl: './changerefund.component.html',
  styleUrls: ['./changerefund.component.css']
})
export class ChangerefundComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.loading = true;
    this.http.put(`refund/${dataToSubmit.id}/`, formData)
      .subscribe(data => {
        const responseData: any = data;
        if (responseData.status === true) {
          this.toastr.success('Refund Done');
          this.onDismiss();
