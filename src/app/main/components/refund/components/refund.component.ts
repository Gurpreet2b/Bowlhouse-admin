...
import { SuccessstatusComponent } from '@main/components/payment/successstatus/components/successstatus.component';
import { ChangerefundComponent } from '../changerefund/components/changerefund.component';
...
export class RefundComponent implements OnInit {
  ...
  onCreate() {
    ...
    const modalRef = this.modalService.open(ChangerefundComponent);
